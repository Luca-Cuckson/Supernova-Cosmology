...
plt.savefig('poster_plot.svg', bbox_inches = 'tight')
...
plt.text(3.435, 35.75, '$\chi^2_{min}=21.5$')
plt.text(3.435, 34.5, 'DoF = 17')
plt.text(3.435, 33.35, '$\chi^2_{reduced}=1.26$')
plt.savefig('L_chi^2.svg', bbox_inches = 'tight')
